...
import bannerImg from "../../assets/flowers2.jpg";
    ...
    <div className="relative min-h-screen overflow-hidden">
      ...
      <div className="relative hero min-h-screen p-10 py-20 lg:px-20">
        <div className="hero-content flex flex-col lg:flex-row justify-between items-center text-neutral-content w-full">
          ...
          {/* Text Section */}
          <div className="flex-1 bg-[#362E2B]/90 lg:relative left-10 p-4 lg:p-10 rounded-xl shadow-2xl shadow-primary text-start backdrop-blur-sm">
            <h1 className="mb-5 text-4xl lg:text-5xl text-secondary font-bold leading-tight">
              Let flowers say what words cannot
            </h1>

            <p className="mb-5 text-base text-neutral-200 max-w-md">
              Delicately wrapped and beautifully composed, each bouquet carries warmth,
              intention, and a quiet kind of magic meant to be felt, not spoken.
            </p>
