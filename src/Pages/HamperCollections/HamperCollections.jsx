    ...
    >
      ...
      <div className="text-center max-w-2xl mx-auto mb-14">
        ...
        <p className="text-secondary/70">
          Thoughtfully curated hampers filled with comfort, indulgence, and care
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        {hampers.slice(0, visibleCount).map((hamper) => (
          <Link key={hamper.id} to={`/hampers/${hamper._id}`}>
            <div
              className="
            ...
            >
              ...
              {/* Content */}
              <div className="p-5">
                <h3 className="text-xl font-semibold mb-1">{hamper.title}</h3>
